 ...
 */
export async function checkIdempotency(key: string, operation: () => Promise<any>): Promise<any> {
 ...
 * Rate limit check
 */
export function rateLimit(_identifier: string, _maxRequests: number, _windowMs: number): boolean {
